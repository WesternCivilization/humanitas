...
namespace RepositoryWatcher
{
    static public class ImageHelper
    {
        ...
        static public string ResizeImageW(string image, int maxWidth, string destinationPath)
        {
        ...
        static public Size GetImageSize(string image)
        {
        ...
        static private void ResizeImage(Bitmap image, int maxWidth, int maxHeight, int quality, string filePath)
        {
        ...
        static private ImageCodecInfo GetEncoderInfo(ImageFormat format)
        {
